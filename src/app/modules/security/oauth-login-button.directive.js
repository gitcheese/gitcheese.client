...
angular.module('gitcheese.app.security')
    .controller('gcOauthLoginButtonController', function(securityService, $location, hello, Restangular, $q, $timeout, facebookPixelService) {
        var vm = this;
        vm.iconSizes = {
            'lg': 5,
            'm': 3,
        ...
        var register = function() {
            return Restangular.several('memberships', vm.provider).post({
                token: vm.token
            });
        };
